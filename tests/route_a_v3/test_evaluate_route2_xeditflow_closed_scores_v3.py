...
def test_frozen_scores_use_common_measured_candidates_and_preserve_undefined() -> None:
    config = {
        ...
        "method_id": "simple_rate_guidance", "score_table_method_id": "simple_rate_guidance",
    ...
    scores = [
        {"source_key": "s", "candidate_sequence": "AA", "frozen_method_score": -1000.0, "method_id": "simple_rate_guidance"},
        {"source_key": "s", "candidate_sequence": "AC", "frozen_method_score": 1000.0, "method_id": "simple_rate_guidance"},
        {"source_key": "u", "candidate_sequence": "GG", "frozen_method_score": 2.0, "method_id": "simple_rate_guidance"},
    ]
    ...
    assert result["score_table_method_id"] == "simple_rate_guidance"
...
def test_frozen_score_table_must_exactly_match_common_candidates() -> None:
    config = {
        ...
        "analysis_unit": "SOURCE", "undefined_source_policy": "EXCLUDE_NOT_ZERO_FILL",
        "score_transform": "SOURCEWISE_EXP_SHIFTED_MAX",
        "method_id": "strongest_matched_baseline", "score_table_method_id": "strongest_matched_baseline",
        "base_flow_training_seed": 20260904,
    }
    measured = [
        {"source_key": "s", "candidate_sequence": "AA", "measured_direction_normalized_delta": 0.0, "pool_assignment": "DEVELOPMENT", "split": "VALIDATION"},
    ...
    scores = [
        {"source_key": "s", "candidate_sequence": "AA", "frozen_method_score": 0.0, "method_id": "strongest_matched_baseline"},
        {"source_key": "s", "candidate_sequence": "AC", "frozen_method_score": 1.0, "method_id": "strongest_matched_baseline"},
        {"source_key": "other", "candidate_sequence": "GG", "frozen_method_score": 2.0, "method_id": "strongest_matched_baseline"},
    ]
...
def test_closed_score_allows_explicit_shared_frozen_search_scorer() -> None:
    config = {
        "schema_version": "route_a_v3_route2_xeditflow_closed_score_config.v1",
        "pool_assignment": "DEVELOPMENT", "split": "VALIDATION",
        "analysis_unit": "SOURCE", "undefined_source_policy": "EXCLUDE_NOT_ZERO_FILL",
        "score_transform": "SOURCEWISE_EXP_SHIFTED_MAX",
        "method_id": "greedy", "score_table_method_id": "strongest_matched_baseline",
        "base_flow_training_seed": 20260904,
    }
    measured = [
        {"source_key": "s", "candidate_sequence": "AA", "measured_direction_normalized_delta": 0.0, "pool_assignment": "DEVELOPMENT", "split": "VALIDATION"},
    ...
    result = evaluate_closed_method_scores_v3(config, measured, scores)
    assert result["method_id"] == "greedy"
    assert result["score_table_method_id"] == "strongest_matched_baseline"
