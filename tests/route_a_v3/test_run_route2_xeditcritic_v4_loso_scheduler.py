...
def test_loso_scheduler_preserves_terminals_and_composes_ready(
    ...
    schedule = {
        ...
        "loso_adjudication": {
            ...
            "command": _writer(loso, {"status": "XEDITCRITIC_V4_LOSO_TERMINAL"}, 9),
        },
        "readiness": {
    ...
    assert payload["loso_adjudication"]["return_code"] == 9
    assert payload["readiness"]["return_code"] == 5
