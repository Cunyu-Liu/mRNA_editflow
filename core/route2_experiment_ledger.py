...
def build_training_attempt_row(
    ...
    *,
    ...
    return {
        ...
        "parameter_initialization_seed": config.get(
            "parameter_initialization_seed", ""
        ),
        "parameter_initialization_seed_applied_before_model_construction": config.get(
            "parameter_initialization_seed_applied_before_model_construction", ""
        ),
        "parameter_initialization_tensor_identity_scope": config.get(
            "parameter_initialization_tensor_identity_scope", ""
        ),
        "physical_gpu_index": config.get("physical_gpu_index", ""),
        "device": config.get("device", ""),
        "cuda_available": config.get("cuda_available", ""),
        "cuda_device_name": config.get("cuda_device_name", ""),
        "a100_device_verified": config.get("a100_device_verified", ""),
        "bf16_supported": config.get("bf16_supported", ""),
        "cpu_fallback_used": config.get("cpu_fallback_used", ""),
        "training_git_head": config.get("training_git_head", ""),
        ...
        "training_summary_path": config.get("training_summary_path", ""),
        "checkpoint_path": config.get("checkpoint_path", ""),
        "training_attempt_path": config.get("training_attempt_path", ""),
