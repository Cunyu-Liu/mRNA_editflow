...
def _next_gates(evidence: Sequence[MeasuredEvidence]) -> list[str]:
    ...
    gates.extend(
        [
            "Run true external LinearDesign/EnsembleDesign/codonGPT baselines and UTR-only baselines.",
...
def build_sota_gap_report(project_root: str) -> dict[str, object]:
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    report = build_sota_gap_report(args.project_root)
