...
CONTROL_RETRY_ORDINAL = 2
CONTROL_RETRY_IDENTITY = "v403_control_recovery_retry2"
...
def validate_prior_control_oom_terminal_receipt(
    ...
    require(
        ...
        "prior Critic controls retry1 terminal inventory is invalid",
    )
    require(
