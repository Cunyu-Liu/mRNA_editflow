...
def run(current_head: str, experiment_head: str) -> dict[str, Any]:
    ...
    component_data: dict[str, dict[str, Any]] = {
        ...
        "setflow": {
            ...
            "preflight": ROOT / "experiments/xeditsetflow_v4/screen_seed_20260911/preflight_attempt_2/preflight.json",
            "source_data_audit": ROOT / "experiments/xeditsetflow_v4/screen_seed_20260911/preflight_attempt_2/source_level_data_audit.json",
