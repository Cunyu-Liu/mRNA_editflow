...
def write_scheduler_launch_failure_evidence(
    ...
    *,
    ...
    require(
        ...
        "Critic refit scheduler launch failure evidence already exists; "
    ...
    write_atomic(
        ...
        {
            "schema_version": (
                "route_a_v3_route2_xeditcritic_v4_refit_"
                "scheduler_launch_failure.v1"
            ),
            "status": "XEDITCRITIC_V4_REFIT_SCHEDULER_LAUNCH_TECHNICAL_FAILURE",
...
def spawn_scheduler_with_failure_evidence(
    *,
    ...
    try:
        ...
        raise XEditCriticV4RefitLaunchError(
            "Critic refit scheduler process could not start; durable "
