...
def validate_config(payload: dict[str, Any]) -> list[dict[str, str]]:
    ...
    exact_expectations: dict[str, Any] = {
        ...
        "terminal_tilt_contract.absorbing_terminal_boundary_h_equals_w": True,
        "terminal_tilt_contract.absorbing_terminal_potential_formula": "V_terminal=log(w_terminal)",
        "terminal_tilt_contract.learned_value_network_evaluated_on_absorbing_terminal_states": False,
