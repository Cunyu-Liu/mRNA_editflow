#!/usr/bin/env python3
"""Prepare, validate, and publish the A1-EVT-051 runtime sync.

EVT051 registers the existing public aggregate-only GSE200304 A1
qualification-authority adjudication. A production prepare verifies each of
the four registered bundle members by exact bytes and SHA-256 identity without
parsing report bodies. Private payloads and row/sequence/effect payloads are
never registered, opened, copied, or listed. The remaining immutable outputs
are three predecessor snapshots and one sync record.
...
FROZEN_I1_BLOB_SHA256 = {
    ...
    TEST_REPO_PATH: "990f47225a13237c42d50abfb7813830d5580c08e1cf2210fb11dd54d42f6581",
}
FROZEN_B1_BLOB_SHA256 = {
    CONFIG_REPO_PATH: "f3d2f3990f8ffe181c5a17fc90785a574e4e1dc3a7df1befc707db3706a1b71b",
...
REGISTERED_ARTIFACTS = [
    {
        ...
        "name": "ADJUDICATION_REPORT.json",
        "artifact_type": "ADJUDICATION_REPORT",
        "absolute_path": "/mnt/cunyuliu/mrna_xeditflow_routea_v3/runs/A1/GSE200304_DEC020_SCRATCH_ROUTE_A1_ADJUDICATION_V4_20260813T143426P0800/ADJUDICATION_REPORT.json",
        "bytes": 2812,
        "sha256": "37ced466a905f8e71bb06ec55550a36d8c2e1d0ff8f03c6dde839562c1680d99",
    },
    {
        "lineage_id": LEDGER_LINEAGE_IDS[0],
        "name": "INPUT_EVIDENCE_AUDIT.json",
        "artifact_type": "INPUT_EVIDENCE_AUDIT",
        "absolute_path": "/mnt/cunyuliu/mrna_xeditflow_routea_v3/runs/A1/GSE200304_DEC020_SCRATCH_ROUTE_A1_ADJUDICATION_V4_20260813T143426P0800/INPUT_EVIDENCE_AUDIT.json",
        "bytes": 2891,
        "sha256": "3fc8171d6f69fb27e3a454bf504efacddcddceb99fffe8b47b59c84c554d1d72",
    },
    {
        "lineage_id": LEDGER_LINEAGE_IDS[0],
        "name": "SHA256SUMS",
        "artifact_type": "SHA256SUMS",
        "absolute_path": "/mnt/cunyuliu/mrna_xeditflow_routea_v3/runs/A1/GSE200304_DEC020_SCRATCH_ROUTE_A1_ADJUDICATION_V4_20260813T143426P0800/SHA256SUMS",
        "bytes": 183,
        "sha256": "c11d227abbf5700c7a9a1b403236e331377f23e20c7192b9effe7bd6428f3fb3",
    },
    {
        "lineage_id": LEDGER_LINEAGE_IDS[0],
        "name": "PUBLICATION_COMMIT.json",
        "artifact_type": "PUBLICATION_COMMIT",
        "absolute_path": "/mnt/cunyuliu/mrna_xeditflow_routea_v3/runs/A1/GSE200304_DEC020_SCRATCH_ROUTE_A1_ADJUDICATION_V4_20260813T143426P0800/PUBLICATION_COMMIT.json",
        "bytes": 1082,
        "sha256": "6597863e9eef342e6539fa886d81b373157f8248baacd519d7b0ebc60a3af2ac",
    },
]
PREDECESSOR_SCIENTIFIC_STATE = {
...
SUCCESSOR_SCIENTIFIC_STATE = {
    "input_status_counts": {"PASS": 7, "BLOCKED": 0, "UNKNOWN_NOT_ASSERTED": 0, "NOT_RUN": 0},
    "unresolved_blockers": [],
    "scratch_route_qualified": True,
    "scratch_route_ordinary_study_contribution": 1,
    "scratch_route_a1_study_contribution": 1,
    "scratch_route_true_a2_study_contribution": 0,
    "scratch_route_canonical_record_count": 6547,
    ...
    "global_required_ordinary_studies": 3,
    "global_required_a1_studies": 2,
    "global_required_true_a2_studies": 1,
    "global_phase_completion_status": "INCOMPLETE",
    "global_phase_completion_gate_passed": False,
    "qualified": False,
    "training_started": False,
    "training_allowed": False,
    "training_authorized": False,
...
REGISTERED_EVIDENCE_TRUTH = {
    ...
    "global_phase": {
        "required_ordinary_studies": 3,
        "required_a1_studies": 2,
        "required_true_a2_studies": 1,
        "current_ordinary_studies": 1,
        "current_a1_studies": 1,
        "current_true_a2_studies": 0,
        "phase_completion_status": "INCOMPLETE",
        "unresolved_blockers": [
            "INSUFFICIENT_QUALIFIED_ORDINARY_STUDIES",
            "INSUFFICIENT_QUALIFIED_A1_STUDIES",
            "NO_QUALIFIED_TRUE_A2_DENSE_STUDY",
        ],
        "overall_A1_phase_completion_gate_changed": False,
    },
    "foundation_route": {
        "input_status_counts": {"PASS": 7, "BLOCKED": 0, "UNKNOWN_NOT_ASSERTED": 1, "NOT_RUN": 0},
        "unresolved_blockers": ["CHECKPOINT_SPECIFIC_EXPOSURE_NOT_PASS"],
        "status": "RETAINED_FAIL_CURRENT_PROTOCOL",
        "checkpoint_evidence_status": "UNKNOWN_NOT_ASSERTED",
    },
    "historical_dec019": {
        "input_status_counts": {"PASS": 7, "BLOCKED": 0, "UNKNOWN_NOT_ASSERTED": 1, "NOT_RUN": 0},
        "unresolved_blockers": ["CHECKPOINT_SPECIFIC_EXPOSURE_NOT_PASS"],
        "status": "HISTORICAL_PRESERVED_NOT_REWRITTEN",
    },
}
OUTER_A1_STATE = {
...
ACCESS_BOUNDARY = {
    ...
    "registered_artifact_exact_byte_validation_count": 4,
    ...
    "private_payload_registered_artifact_count": 0,
    "private_payload_copied": False,
    "private_payload_listed": False,
...
class RuntimeSyncError(RuntimeError):
    """Base class for an EVT051 validation/publication error."""
...
class PredecessorError(RuntimeSyncError):
    """The runtime is not the exact EVT050 predecessor or a supported prefix."""
...
def _validate_ledger_binding(ledger: Mapping[str, Any]) -> None:
    """Allow only the grouped exact4 UNKNOWN candidate or one fully bound L."""
    ...
    _expect(
        ledger.get("manifest_status"),
        (
            "A1_GSE200304_DEC020_SCRATCH_ROUTE_V4_QUALIFIED_"
            "LEDGER_REGISTERED_EVT050_SETTLED_PENDING_FRESH_RUNTIME_EVENT"
        ),
...
def _validate_runtime_shape(config: dict[str, Any]) -> None:
    ...
    _expect(runtime["predecessor_event_id"], "A1-EVT-050", label="predecessor event id")
    _expect(runtime["successor_event_id"], "A1-EVT-051", label="successor event id")
    for key, expected in (
        ("predecessor_event_count", 50),
        ("successor_event_count", 51),
        ("predecessor_manifest_output_count", 212),
        ("successor_manifest_output_count", 220),
    ...
    _expect(tail["event_id"], "A1-EVT-050", label="predecessor tail event")
    _expect(tail["decision_id"], "V3-DEC-020", label="predecessor tail decision")
    ...
    _expect(
        runtime["sync_name"],
        "A1_GSE200304_DEC020_V4_QUALIFICATION_RUNTIME_SYNC_V1.json",
        label="sync name",
    )
    immutable_expected = [
...
def validate_static_config(config: dict[str, Any]) -> None:
    ...
    _expect(
        ...
        {
            "schema_version": (
                "route_a_v3_gse200304_dec020_v4_qualification_runtime_sync.v1"
            ),
            "protocol_id": (
                "ROUTE_A_V3_GSE200304_DEC020_V4_QUALIFICATION_RUNTIME_SYNC_V1"
            ),
            ...
            "event_id": "A1-EVT-051",
            "event_name": (
                "GSE200304_DEC020_SCRATCH_ROUTE_A1_QUALIFICATION_REGISTERED_RUNTIME_SYNCED"
            ),
        },
    ...
    _expect(registered, REGISTERED_ARTIFACTS, label="ledger-ordered exact4 artifact")
    ...
    if any(item["absolute_path"].endswith(".jsonl") for item in registered):
        raise RuntimeSyncError("line-oriented runtime payload cannot be a registered artifact")
    ...
    materialization = _expect_keys(
        evidence.get("GSE200304_development_v3_materialization"),
        {"failed_attempt", "current_materialization"},
        label="GSE200304 materialization truth",
    )
    _expect(
        materialization["failed_attempt"],
        {
            "lineage_id": "GSE200304_development_v3_materialization_attempt_001_failure",
            "artifact_type": (
                "GSE200304_DEVELOPMENT_V3_MATERIALIZATION_"
            ...
            "superseded_for_current_execution_by_lineage_id": (
                "GSE200304_development_v3_materialization_v1"
            ),
    ...
    _expect(
        ...
        {
            "lineage_id": "GSE200304_development_v3_materialization_v1",
            "artifact_type": (
                "GSE200304_DEVELOPMENT_V3_MATERIALIZATION_REPORT_AGGREGATE_ONLY"
            ),
    ...
    _expect(
        evidence.get("gse200304_dec020_v4_qualification"),
        {
            "schema_version": (
                "route_a_v3_gse200304_dec020_v4_qualification.v1"
            ),
        ...
        label="GSE200304 DEC020 scratch-route adjudication truth",
    )
    _expect(
...
def validate_static_config(config: dict[str, Any]) -> None:
    """Validate the EVT051 candidate without opening Git, artifacts, or runtime."""

    _expect_keys(
        config,
        {
            "schema_version", "protocol_id", "contract_id", "phase_id", "dataset_ids",
            "decision_id", "event_id", "event_name", "sync_type", "implementation_binding",
            "repository_authority", "registered_artifacts", "runtime",
            "successor_scientific_state", "registered_evidence_truth", "outer_a1_state",
            "access_boundary", "publication_policy",
        },
        label="config root",
    )
    _expect(
        ...
        {
            "schema_version": "route_a_v3_gse200304_dec020_v4_qualification_runtime_sync.v1",
            "protocol_id": "ROUTE_A_V3_GSE200304_DEC020_V4_QUALIFICATION_RUNTIME_SYNC_V1",
            "contract_id": "mrna_xeditflow_route_a_v3",
            "phase_id": "A1",
            "dataset_ids": ["GSE200304"],
            "decision_id": "V3-DEC-020",
            "event_id": "A1-EVT-051",
            "event_name": "GSE200304_DEC020_SCRATCH_ROUTE_A1_QUALIFICATION_REGISTERED_RUNTIME_SYNCED",
            "sync_type": "APPEND_ONLY_QUALIFICATION_EVIDENCE_REGISTRATION_SCIENTIFIC_STATE_CHANGED_PHASE_GATE_UNCHANGED",
        },
        label="config identity",
    )
    binding = _expect_keys(
        ...
        {"binding_scheme", "status", "implementation_commit", "implementation_script_path",
         ...
         "compiled_core_sha256", "unknown_to_bound_scalar_paths", "activation_rule"},
        label="implementation binding",
    )
    _expect(binding["binding_scheme"], "CONFIG_ONLY_POST_IMPLEMENTATION_BINDING_V1", label="binding scheme")
    _expect(binding["implementation_script_path"], SCRIPT_REPO_PATH, label="script path")
    _expect(binding["implementation_test_path"], TEST_REPO_PATH, label="test path")
    _expect(binding["unknown_to_bound_scalar_paths"], [
        "implementation_binding.status",
        "implementation_binding.implementation_commit",
        "implementation_binding.implementation_script_sha256",
        "implementation_binding.implementation_test_sha256",
    ], label="implementation binding scalar paths")
    values = [binding[key] for key in ("status", "implementation_commit", "implementation_script_sha256", "implementation_test_sha256")]
    if any(value == UNKNOWN for value in values):
        if not _binding_values_are_unknown(binding):
            raise BindingError("implementation binding is partially known")
    else:
        ...
        _expect_hex(binding["implementation_script_sha256"], HEX64, label="implementation script SHA")
        _expect_hex(binding["implementation_test_sha256"], HEX64, label="implementation test SHA")
    if binding["compiled_core_sha256"] != CORE_PLACEHOLDER:
        _expect_hex(binding["compiled_core_sha256"], HEX64, label="compiled core SHA")
        _expect(binding["compiled_core_sha256"], compiled_core_sha256(config), label="compiled core")

    authority = _expect_keys(
        config["repository_authority"],
        {"production_repo_root", "branch", "implementation_exact_changed_paths",
         "binding_exact_changed_paths", "frozen_runtime_sync_lifecycle",
         "predecessor_ledger"},
        label="repository authority",
    )
    _expect(authority["production_repo_root"], str(PRODUCTION_REPO_ROOT), label="production repository root")
    _expect(authority["branch"], "routea-v3-a1-20260810", label="repository branch")
    _expect(authority["implementation_exact_changed_paths"], [CONFIG_REPO_PATH, SCRIPT_REPO_PATH, TEST_REPO_PATH], label="implementation exact3 paths")
    ...
    if not _ledger_values_are_unknown(ledger):
        _expect(ledger["registered_lineage_ids"], LEDGER_LINEAGE_IDS, label="registered lineage order")
        if any(item["lineage_id"] not in ledger["registered_lineage_ids"] for item in REGISTERED_ARTIFACTS):
            raise RuntimeSyncError("registered artifact lineage order drift")
    for item in REGISTERED_ARTIFACTS:
        _expect(Path(item["absolute_path"]).name, item["name"], label="registered basename")
        if item["absolute_path"].endswith(".jsonl"):
            raise RuntimeSyncError("line-oriented runtime payload cannot be a registered artifact")
    _validate_runtime_shape(config)
    _expect(config["successor_scientific_state"], SUCCESSOR_SCIENTIFIC_STATE, label="successor scientific truth")
    _expect(config["registered_evidence_truth"], REGISTERED_EVIDENCE_TRUTH, label="registered evidence truth")
    ...
    _expect(config["publication_policy"], {
        "registered_artifacts_remain_in_place": True,
        "registered_artifact_order_is_ledger_lineage_order": True,
        "predecessor_snapshots_are_immutable_runtime_outputs": True,
        "sync_record_is_immutable_runtime_output": True,
...
def validate_bound_config(config: dict[str, Any]) -> None:
    validate_static_config(config)
    if _ledger_values_are_unknown(config["repository_authority"]["predecessor_ledger"]):
        raise BindingError("predecessor ledger authority is not BOUND")
...
def audit_production_repository_authority(
    ...
    _expect(
        _changed_paths(repo_root, FROZEN_B1_COMMIT),
        sorted(authority["binding_exact_changed_paths"]),
        label="B1 exact config-only paths",
    )
    _expect(
...
def validate_registered_artifacts(
    ...
    """Validate the exact4 registered bundle without parsing report bodies."""
    ...
    return {
        "status": (
            "EXACT4_BYTES_AND_SHA256_VALIDATED"
            if verify_exact_bytes
            else "EXACT4_METADATA_VALIDATED"
        ),
...
def _validate_recorded_at(recorded_at: str, predecessor_at: Any) -> None:
    ...
    if current.tzinfo is None or predecessor.tzinfo is None or current <= predecessor:
        raise PredecessorError("EVT051 timestamp must follow EVT050 with an explicit offset")
...
def validate_predecessor(
    ...
    """Validate EVT050 before creating any prepared member."""
    ...
    if len(events) != runtime["predecessor_event_count"]:
        raise PredecessorError("predecessor event count is not 50")
    tail = events[-1] if events else {}
    _expect(tail.get("event_id"), "A1-EVT-050", label="predecessor tail event")
    _expect(tail.get("decision_id"), "V3-DEC-020", label="predecessor decision")
    outputs = manifest.get("outputs")
    if not isinstance(outputs, list) or len(outputs) != runtime["predecessor_manifest_output_count"]:
        raise PredecessorError("predecessor manifest output count is not 212")
    expected_scientific = PREDECESSOR_SCIENTIFIC_STATE
...
def _event_document(
    ...
    *,
    ...
    return {
        ...
        "registered_artifact_count": 4,
        "registered_lineage_ids": copy.deepcopy(LEDGER_LINEAGE_IDS),
        "registered_artifacts_copied": False,
        "registered_artifact_exact_byte_validation_count": 4,
        "registered_artifact_body_parse_count": 0,
        "registered_artifact_payload_field_read_count": 0,
        ...
        "new_runtime_output_count": 8,
        "scientific_state_changed": True,
        "dataset_qualification_changed": True,
        "overall_A1_phase_completion_gate_changed": False,
        ...
        "next_phase_authorized": False,
        "detail": (
            "Registered the four-member aggregate-only GSE200304 DEC020 scratch-route "
            "adjudication by exact bytes in place, then added three immutable EVT050 "
            "snapshots and one sync record. The scratch route is qualified and adds one "
            "ordinary plus one A1 study (canonical materialization remains eligible but "
            "execution is false); global requirements remain 3/2/1 and incomplete. "
            "Scientific state and dataset qualification changed, while the overall A1 "
            "phase gate stayed unchanged. No private, row, sequence, or effect payload "
            "was registered, read, copied, or listed. Training, GPU, model selection, "
            "next phase, and the scientific claim remain locked."
        ),
    }
...
def _build_sync_record(
    ...
    return json_bytes(
        {
            "record_type": "ROUTE_A_V3_A1_GSE200304_DEC020_V4_QUALIFICATION_RUNTIME_SYNC",
            "event_id": "A1-EVT-051",
            "decision_id": "V3-DEC-020",
...
def _immutable_outputs(
    ...
    # EVT050 has 212 outputs. EVT051 appends four registered bundle members,
    # then three snapshots and one sync record, for 220.
...
def build_successors(
    ...
    # The successor records the scientific transition separately from the
    # retained EVT050 predecessor.  Keep current scratch-route qualification
    # (7/0/0/0, no current blockers) distinct from historical/foundation axes.
    successor_status.update(copy.deepcopy(SUCCESSOR_SCIENTIFIC_STATE))
    successor_status.update(copy.deepcopy(OUTER_A1_STATE))
    successor_status["claim_status"] = "NOT_ESTABLISHED"
    successor_status["canonical_record_count"] = 6547
    successor_manifest.update(copy.deepcopy(SUCCESSOR_SCIENTIFIC_STATE))
    successor_manifest.update(copy.deepcopy(OUTER_A1_STATE))
    successor_manifest["claim_status"] = "NOT_ESTABLISHED"
    successor_manifest["canonical_record_count"] = 6547
    ...
    # output list itself.
    successor_manifest["registered_artifact_count"] = 4
...
def validate_successors(
    ...
    """Check exact3 mutable prefix, exact4 bundle plus snapshots/sync, and EVT051 last."""
    ...
    if len(events) != runtime["successor_event_count"] or events[:-1] != old_events:
        raise RuntimeSyncError("EVT051 is not one append-only event")
    event = events[-1]
    _expect(event.get("event_id"), "A1-EVT-051", label="successor event")
    _expect(event.get("decision_id"), "V3-DEC-020", label="successor event decision")
    _expect(event.get("scientific_state_changed"), True, label="event scientific state change")
    _expect(event.get("dataset_qualification_changed"), True, label="event dataset qualification change")
    _expect(event.get("overall_A1_phase_completion_gate_changed"), False, label="event overall A1 phase gate change")
    if not isinstance(event.get("at"), str):
        raise RuntimeSyncError("EVT051 timestamp is absent")
    outputs = manifest.get("outputs")
    if not isinstance(outputs, list) or len(outputs) != runtime["successor_manifest_output_count"]:
        raise RuntimeSyncError("successor manifest output count is not 220")
    ...
    registered_end = registered_start + len(expected_registered)
    if outputs[registered_start:registered_end] != expected_registered:
        raise RuntimeSyncError("registered exact4 output metadata drift")
    ...
    if len({item.get("absolute_path") for item in outputs}) != 220:
        raise RuntimeSyncError("successor output paths are not unique")
    expected_status = copy.deepcopy(old_status)
    expected_status.update(copy.deepcopy(SUCCESSOR_SCIENTIFIC_STATE))
    expected_status.update(copy.deepcopy(OUTER_A1_STATE))
    expected_status["claim_status"] = "NOT_ESTABLISHED"
    expected_status["canonical_record_count"] = 6547
    ...
    expected_manifest.update(copy.deepcopy(SUCCESSOR_SCIENTIFIC_STATE))
    expected_manifest.update(copy.deepcopy(OUTER_A1_STATE))
    expected_manifest["claim_status"] = "NOT_ESTABLISHED"
    expected_manifest["canonical_record_count"] = 6547
    expected_manifest["registered_artifact_count"] = 4
    ...
    _expect(sync.get("event_id"), "A1-EVT-051", label="sync event id")
    _expect(sync.get("registered_artifact_count"), 4, label="sync exact4 count")
    _expect(sync.get("registered_artifacts"), expected_registered, label="sync exact4 metadata")
    _expect(sync.get("output_delta_count"), 8, label="sync output delta")
    _expect(sync.get("scientific_state_changed"), True, label="sync scientific state change")
    _expect(sync.get("dataset_qualification_changed"), True, label="sync dataset qualification change")
    _expect(sync.get("overall_A1_phase_completion_gate_changed"), False, label="sync overall A1 phase gate change")
...
def _published_state_is_exact(config: dict[str, Any], payloads: Mapping[str, bytes]) -> bool:
    ...
    outputs = manifest.get("outputs")
    return (
        events[-1].get("event_id") == "A1-EVT-051"
        and events[-1].get("decision_id") == "V3-DEC-020"
    ...
    *,
    ...
    with _locked_run(run_root):
        ...
        if _published_state_is_exact(config, predecessor):
            return {"status": "ALREADY_PUBLISHED_VERIFIED", "event_id": "A1-EVT-051"}
    ...
    return {
        ...
        "manifest_output_transition": "212_TO_220",
        "new_runtime_output_count": 8,
    }
    ...
    *,
    ...
    with _locked_run(run_root):
        ...
        try:
            ...
            raise PublicationError(
                "EVT051 was not committed; retry with the same prepared directory"
            ) from exc
        final = _read_runtime(run_root)
        if final != successor:
            raise PublicationError("EVT051 publication finished with non-exact mutables")
        return {
            "status": "PUBLISHED_VERIFIED",
            "event_id": "A1-EVT-051",
            "reused": False,
    ...
    *,
    ...
    with _locked_run(run_root):
        ...
        if current != successor:
            raise PublicationError("runtime does not exactly match prepared EVT051 successor")
        for name in config["runtime"]["immutable_publish_order"]:
    ...
    return {"status": "PUBLISHED_VERIFIED", "event_id": "A1-EVT-051"}
