...
- `required_splits_unavailable:ood_family_test,length_shift_test,gc_shift_test`
- `required_oracles_unavailable:training,heldout,alternative`
- `heldout_oracle_not_independent`
- `alternative_oracle_not_independent`
...
| ood_family_test | missing |  |  |  | manifest_path_not_supplied |
| length_shift_test | missing |  |  |  | manifest_path_not_supplied |
| gc_shift_test | missing |  |  |  | manifest_path_not_supplied |
| species_shift_test | missing |  |  |  | manifest_path_not_supplied |

| item | status | oracle_type | independent | manifest_sha256 | reason |
| --- | --- | --- | --- | --- | --- |
| training | missing |  |  |  | oracle_manifest_not_supplied |
| heldout | missing |  |  |  | oracle_manifest_not_supplied |
| alternative | missing |  |  |  | oracle_manifest_not_supplied |
